...
export default function Farmer() { // Renamed to start with an uppercase letter
    ...
    return (
        <div>
            <h1 style={{ color: '#017840' }}>Farmer</h1>
            <Box sx={{ flexGrow: 1 }}>
            ...
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={1}>
                    <Grid item xs={12}>
                        <Item style={{ textAlign: 'left', backgroundColor: '#017840', color: '#fff', fontWeight: 'bold', fontSize: '20px' }}>Farmer Info</Item>
                    </Grid>
                    <Grid item xs={4}>
                        <h4>Land Type</h4>
                        <FormControl variant="outlined" style={{ width: '60%' }}>
                    ...
                    <Grid item xs={4}>
                        <h4>Land Size</h4>
                        <TextField id="filled-basic" label="Enter Land Size" variant="filled" style={{ width: '60%', height: '43%' }} />
                    </Grid>
                    <Grid item xs={4}>
                        <h4>Crops Type</h4>
                        <FormControl variant="outlined" style={{ width: '60%' }}>
